...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<DenemeLog> DenemeLogs { get; set; }
    ...
    public virtual DbSet<VwGetir> VwGetirs { get; set; }
    public virtual DbSet<User> Users { get; set; }


    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-I8RD6T2\\SQLEXPRESS;Initial Catalog=Northwind;trusted_connection=true;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Category>(entity =>
        {
            ...
            entity.Property(e => e.PicturePath).HasColumnType("ntext");
        });
        ...
        modelBuilder.Entity<Deneme>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("deneme", tb => tb.HasTrigger("tg_delete"));
        ...
        modelBuilder.Entity<DenemeLog>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__deneme_l__3213E83F3B518EAD");

            entity.ToTable("deneme_log");
        ...
        modelBuilder.Entity<VwGetir>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_Getir");
            ...
            entity.Property(e => e.Adi)
                ...
                .HasColumnName("ADI");
            entity.Property(e => e.Id).HasColumnName("ID");
            entity.Property(e => e.Katergoriadi)
                .HasMaxLength(15)
                .HasColumnName("KATERGORIADI");
            entity.Property(e => e.SatışSayısı).HasColumnName("satış sayısı");
            entity.Property(e => e.Soyadı).HasMaxLength(20);
        });
